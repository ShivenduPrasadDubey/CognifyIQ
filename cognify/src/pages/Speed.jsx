...
const Speed = () => {
  ...
  useEffect(() => {
    const fetchScores = async () => {
      try {
        const response = await axios.get(`https://cognifyiq.onrender.com/api/leaderboard/Speed`); // Change endpoint to fetch scores
  ...
  const saveScore = async (reactionDuration) => {
    if (user) {
      try {
        ...
        const response = await axios.get(`https://cognifyiq.onrender.com/api/Speed`);
        setScores(response.data);
